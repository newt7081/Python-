...
browser.find_element_by_css_selector("[aria-labelledby='i1']").send_keys(text1)
browser.find_element_by_css_selector("[aria-labelledby='i5']").click()
browser.find_element_by_css_selector("[aria-labelledby='i5']").send_keys(text2)
# 選擇
...
# browser.find_element_by_css_selector("[id='i160']").click()   # 疫苗否
